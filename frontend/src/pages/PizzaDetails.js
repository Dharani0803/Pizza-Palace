...
function PizzaDetails() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <img src={pizza.imageUrl} alt="Pizza item" className="w-full h-[370px] object-cover"/>
      ...
      <div className="p-3">
        ...
        <p className="text-gray-600 mt-3">{pizza.description}</p>
        ...
        {cartItem ? (
          ...
          <button onClick={() => addToCart(pizza)}
           className="bg-[#E31837] text-white py-2 w-full rounded-md">Add +</button>
        )}
        </div>
      </div>
