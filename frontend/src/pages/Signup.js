  ...
  return (
    <div className="min-h-screen bg-[#F4F4F6] flex items-center justify-center">
      <div className="bg-white w-[400px] p-8 rounded-2xl shadow-sm">
        <p className="text-3xl font-bold mb-2">Create Account</p>
        <p className="text-gray-500 mb-8">Signup to continue</p>
        ...
        <button onClick={handleSignup} className="w-full bg-[#E31837] text-white py-3 rounded-xl font-semibold">
          Signup
        </button>
        ...
        <p className="text-sm text-center mt-6">
          ...
          <Link to="/login" className="text-[#E31837] font-semibold">Login</Link>
        </p>
