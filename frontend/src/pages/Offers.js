  ...
  return (
    <div className="m-5">
      <div className="flex gap-3">
        ...
        <h1 className="text-xl font-bold">Deals & Offers</h1>
      </div>
      ...
      <div className="mt-5 flex flex-col gap-5">
        ...
        <div className="flex justify-between items-center rounded-lg text-white p-4 bg-gradient-to-b from-[#0254B1] to-[#1879D2]">
          <div>
            ...
            <p className="text-sm">Upto ₹30 Off on orders of ₹199 or more</p>
          </div>

          <button onClick={() => toggleOffer("GET30")} className={`text-sm border px-3 py-1 rounded-md font-semibold ${
        ...
        <div className="flex justify-between items-center rounded-lg text-white p-4 bg-gradient-to-b from-orange-700 to-orange-500">
          <div>
            ...
            <p className="text-sm">No delivery fee on your order today</p>
          </div>

          <button onClick={() => toggleOffer("FREEDEL")} className={`text-sm border px-3 py-1 rounded-md font-semibold ${
            appliedOffer === "FREEDEL" ? "bg-white text-orange-600" : "text-white" }`}>
